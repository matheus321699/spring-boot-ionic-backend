...
import com.github.matheus321699.cursomc.domain.Pagamento;
...
import com.github.matheus321699.cursomc.repositories.CidadeRepository;
...
import com.github.matheus321699.cursomc.repositories.EstadoRepository;
...
/*
 * Indicando que a classe é um Service para que ela seja reconhecida
 * como um componente do spring, podendo ser injetado em outros lugares.
 */
@Service
public class DBService {
	...
	/*
	 * Método para instanciar objetos para o banco de dados, evitando
	 * poluir a classe CursomcApplication.java.
	 */
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "matheus260400@gmail.com", "35331654509", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("32245154", "98754132"));
	
		Cliente cli2 = new Cliente(null, "Ana Costa", "matheus321699@gmail.com", "38322158165", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("32659874", "98546321"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "360", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "35463246", cli2, c2);
